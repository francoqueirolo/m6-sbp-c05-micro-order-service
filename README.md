...
## 📋 Descripción
Microservicio para la gestión de ordenes desarrollado con Spring Boot 3.5.6. Este servicio forma parte de un ecosistema de microservicios y utiliza PostgreSQL como base de datos.
...
- `SERVER_PORT`: Puerto de la aplicación (por defecto: 8083)
...
1. **Iniciar la base de datos con Docker**
   ```
   docker-compose up -d postgres-order-dev
   ```
